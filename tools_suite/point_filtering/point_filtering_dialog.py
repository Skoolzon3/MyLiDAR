...
class PointFilteringDialog(QDialog):
    ...
    def __init__(self, parent=None, translator=None):
        ...
        self.log_edit.setPlaceholderText(self.tr("Default: <output>_point_filtering_report.txt"))
    ...
    def update_default_log_path(self):
        ...
        output_path = self.output_edit.text().strip()
        default_log = default_suffix_path(output_path, "_point_filtering_report", ".txt")
        if not default_log:
            return
    ...
    def select_log_file(self):
        ...
        if not initial_path:
            output_path = self.output_edit.text().strip()
            initial_path = default_suffix_path(output_path, "_point_filtering_report", ".txt") or ""
